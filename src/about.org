...
Clinical Data Scientist / Forward Deployment Engineer at [[https://www.newtonstree.ai/][Newton's Tree]].

Previously a trainee Magnetic Resonance Physicist for NHS Wales working with =Python=, =Elisp=, =SQL= and big magnets.

Outwith employment, I dabble in many programming languages - mainly =Forth=, =Common Lisp=, =R=, =Fortran=, =Rust= and =Perl=.
...
- PhD (graduate) :: Swansea University - Deep Residual Graph Convolutional Neural Networks for Real Time Uncertainty Quantification of 1D Haemodynamic Vessel System Metrics
